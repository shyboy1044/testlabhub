...
<div id="lab_reservation">
    <section class="home">
        <form action="{{route('labReservationOneAjax')}}" method="post">
            @csrf
            ...
            <div class="booking_area">
                ...
                <div class="select_your_booking">
                    ...
                    <p>You can see here your<br />booking summary</p>
                </div>
            </div>
                    ...
                    <div class="lab_type lab_type-{{str_replace(' ', '', $key)}}">
                        ...
                        <div class="lab_type_box">
                            ...
                            <div class="lab_type_price">
                                ...
                                <h3 class="price_sum" name="totalPrice">{{$lab_type->total_price}} </h3>
                            </div>
                        </div>
                        @endforeach
                    </div>
