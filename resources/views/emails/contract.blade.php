            ...
            <div class="row d-flex justify-content-center visible" id="part_1">
                <div class="main-container">
                        ...
                        <div class="bg-white pl-4 pr-4">
                            ...
                            between <b>{!! $items['lab_name'] !!}</b>, and Telcron LLC of P.O. Box 1398,Montclair, New Jersey 
                        ...
                        <div class="bg-white p-4 mt-4 radius-top radius-bottom">
                            <span>Please read and accept the following details of contract for services.
                                ...
                                <div>1. DESCRIPTION OF SERVICES. Beginning on February 4, 2013, Telcron LLC will provide to
                                    <b>&nbsp;</b><b>{!! $items['lab_name'] !!}</b>  the following services (collectively, the "Services"):
                                ...
                                <div>2. PAYMENT. Payment shall be made to Telcron LLC, Montclair, New Jersey 07042. 
                                    <b>&nbsp;</b><b>{!! $items['lab_name'] !!}</b>   agrees to pay Telcron LLC as follows:
                                    ...
                                    <b>{!! $items['lab_name'] !!}</b> . In the event that a credit has been provided, the commission that has been
                                ...
                                <div>5. CONFIDENTIALITY. Telcron LLC, and its employees, agents, or representatives will not at
                                    ...
                                    LLC, or divulge, disclose, or communicate in any manner, any information that is proprietary to <b>{!! $items['lab_name'] !!}</b>
                                    ...
                                    Upon termination of this Contract, Teleron LLC will return to <b>{!! $items['lab_name'] !!} &nbsp;</b>
                                    all records,
